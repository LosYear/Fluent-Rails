...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { content: @block.content, name: @block.name, status: @block.status, title: @block.title, type: @block.type }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { content: @block.content, name: @block.name, status: @block.status, title: @block.title, type: @block.type }
    assert_redirected_to block_path(assigns(:block))
  end
