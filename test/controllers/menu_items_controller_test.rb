...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { menu_id: @menu_item.menu_id, order: @menu_item.order, parent_id: @menu_item.parent_id, status: @menu_item.status, title: @menu_item.title, type: @menu_item.type, url: @menu_item.url }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { menu_id: @menu_item.menu_id, order: @menu_item.order, parent_id: @menu_item.parent_id, status: @menu_item.status, title: @menu_item.title, type: @menu_item.type, url: @menu_item.url }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
