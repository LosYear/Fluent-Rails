...
class SocialsControllerTest < ActionController::TestCase
  ...
  test "should create social" do
    assert_difference('Social.count') do
      post :create, social: { link: @social.link, logo: @social.logo, order: @social.order, status: @social.status, title: @social.title }
    end
  ...
  test "should update social" do
    patch :update, id: @social, social: { link: @social.link, logo: @social.logo, order: @social.order, status: @social.status, title: @social.title }
    assert_redirected_to social_path(assigns(:social))
  end
